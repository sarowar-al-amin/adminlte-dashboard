...
<html lang="en">
  <head>
    ...
    <title>Resource Engineering</title>
  ...
  <body class="hold-transition sidebar-mini">
      <div class="wrapper">
          {{-- Navigation bar/ comment out because navigation bar is defined here --}}
          {{-- @yield('navbar') --}}
          ...
          {{-- Side Bar / comment out because sidebar is also defined here--}}
          {{-- @yield('sidebar') --}}
          <aside class="main-sidebar sidebar-dark-primary elevation-4">
              <!-- Brand Logo -->
              <a href="#" class="brand-link">
                <img src="template/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">Resource Engineering </span>
              </a>
          ...
          {{-- Footer part/ comment out because footer is defined here too. --}}
          {{-- @yield('main-footer') --}}
